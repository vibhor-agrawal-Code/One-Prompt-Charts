...
def is_valid_openai_key(api_key: str) -> bool:
    ...
    """
    try:
        Client = OpenAI(api_key="sk-QQ6dsUVp0ZYBg23iHt9s-ltMXXsTm267uUtBl5rbN-T3BlbkFJMHpREQXv__Xph0TfdE6OyXXRWnDl-UYI4Igvli7yMA")
...
def key_check():
    ...
    try:
        ...
        openai.api_key = "sk-QQ6dsUVp0ZYBg23iHt9s-ltMXXsTm267uUtBl5rbN-T3BlbkFJMHpREQXv__Xph0TfdE6OyXXRWnDl-UYI4Igvli7yMA"
